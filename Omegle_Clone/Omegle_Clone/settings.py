"""
Django settings for Omegle_Clone project.
...
SECRET_KEY = 'django-insecure-4$!fd!wzll-mp%1h3ukgik8sk=62(b9ce0+37#g2_5uk*n3@yu'
...
ROOT_URLCONF = 'Omegle_Clone.urls'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'Chat/static')  # Path to the static folder
]
